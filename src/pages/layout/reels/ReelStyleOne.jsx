    ...
    <div className='container flex flex-col justify-center'>
      ...
      <div className='grid lg:grid-cols-4 md:grid-cols-6 gap-6 mt-12'>
        ...
        <div className={`safe-area flex items-center justify-center w-full lg:col-span-2 md:col-span-4`}>
          <div className={`w-[360px] h-[640px] overflow-hidden relative shadow-2xl flex flex-col items-center justify-center bg-white renderthis` } ref={elementRef}>
            {previewURL && (
            ...
            {previewURL && (
              <div className='absolute top-4 left-1 z-50'>
                <svg width="141" height="29.62" viewBox="0 0 310 84" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {previewURL && (
              <div className='absolute top-0 left-0 h-[200px] w-full'>
                <div className='bg-gradient-to-b from-[#000000CC] to-[#00000000] h-[150px]'></div>
              </div>
            )}

            {previewURL && (
              <div className='z-[9999] pb-6 absolute bottom-16 left-6 w-[320px]'>
                <div className='flex flex-col text-left gap-1 htmlrender-detail'>
                  <h1 className='text-white text-md w-full font-bold leading-none' id='title'>{isCheckedTitle ? ( <div><HtmlRenderer html={inputEventDescTitle} /></div> ) : null} </h1>
                  <p className='text-white w-full text-xl font-semibold leading-none'>{isCheckedSubTitle ? ( <div><HtmlRenderer html={inputEventDescSubTitle} /></div> ) : null}</p>
                </div>
              </div>
            )}

            {previewURL && (
              <div className='z-50 pb-6 absolute bottom-4 left-6 w-[320px] z-[999]'>
                <div className='flex flex-col text-center gap-2 htmlrender-detail'>
                  <p className='text-white w-full text-[.8rem] font-light text-center'> {isCheckedCopyright ? ( <div className='flex items-center gap-2 justify-start'><Camera className='w-5 h-5' /> <HtmlRenderer html={inputEventDescCopyright} /></div> ) : null}</p>
                </div>
              </div>
            )}

            <svg width="577" height="577" className='z-50 scale-[.3] absolute -bottom-[190px] -left-[250px]' viewBox="0 0 577 577" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg width="577" height="577" className='z-50 scale-[.3] absolute -bottom-[220px] -right-[250px]' viewBox="0 0 577 577" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#clip0_38_123)">
              <path d="M288.38 576.413C447.469 576.413 576.436 447.446 576.436 288.357C576.436 129.268 447.469 0.300781 288.38 0.300781C129.291 0.300781 0.324219 129.268 0.324219 288.357C0.324219 447.446 129.291 576.413 288.38 576.413Z" fill="url(#paint0_radial_38_123)"/>
              </g>
              <defs>
            ...
            <div className='absolute bottom-0 left-0 h-[220px] w-full'>
