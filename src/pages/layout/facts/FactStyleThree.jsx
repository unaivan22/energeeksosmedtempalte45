...
function FactStyleThree() {
  ...
  const [isCheckedHastag, setIsCheckedHastag] = useState(true);
  ...
  const [inputEventDescHastag, setInputEventDescHastag] = useState('Geser');
          ...
          <div className={`w-[1200px] h-[1500px] overflow-hidden relative shadow-2xl flex flex-col items-center justify-center bg-white renderthis` } ref={elementRef}>
            {previewURL && (
              ...
              <div className='cursor-grab top-0' id='StepName'>
                ...
                <motion.img src={previewURL} alt="Preview" className={`scale-${sliderValueScale}`}  drag dragConstraints={constraintsRef}/>
              </div>
            )}
            ...
            {/* <div className='absolute bottom-0 left-0'>
              <div className='w-[1000px] min-h-[200px] h-fit pt-40 pb-8 px-10 bg-[#E74C3C] opacity-90 rounded-t-[30px]'>
                <div className='flex flex-col text-left gap-2 htmlrender-detail'>
                  <h1 className='text-white text-center pb-24 text-[40px] w-full font-bold leading-none' id='title'>{isCheckedTitle ? ( <div><HtmlRenderer html={inputEventDescTitle} /></div> ) : null} </h1>
                  <p className='text-white w-full text-[22px]'>{isCheckedSubTitle ? ( <div><HtmlRenderer html={inputEventDescSubTitle} /></div> ) : null}</p>
                  <p className='text-white w-full font-semibold text-[22px] py-6'>{isCheckedHastag ? ( <div className='flex flex-row items-center justify-end gap-x-2'><HtmlRenderer html={inputEventDescHastag} /><ArrowRight className='w-7 h-7' /> </div> ) : null}</p>
                </div>
              </div>
            </div> */}

            <div className='absolute bottom-0 left-0'>
              <div className='w-[1200px] min-h-[200px] h-fit pt-40 pb-8 px-10 bg-[#E74C3C] opacity-90 rounded-t-[30px]'>
                <div className='flex flex-col text-left gap-2 htmlrender-detail px-[40px] pt-[30px'>
                  <h1 className='text-white text-center pb-24 text-[40px] w-full font-bold leading-[50px]' id='title'>{isCheckedTitle ? ( <div><HtmlRenderer html={inputEventDescTitle} /></div> ) : null} </h1>
                  <div className='flex items-center justify-between mt-10'>
                    <p className='text-white w-full text-[2rem] font-light text-left'> {isCheckedCopyright ? ( <div className='flex items-center gap-2 justify-start'><Camera className='w-8 h-8' /> <HtmlRenderer html={inputEventDescCopyright} /></div> ) : null}</p>
                    <p className='text-white w-full font-semibold text-[2rem] py-6'>{isCheckedHastag ? ( <div className='flex flex-row items-center justify-end gap-x-2'><HtmlRenderer html={inputEventDescHastag} /><ArrowRight className='w-7 h-7' /> </div> ) : null}</p>
                  </div>
                </div>
              </div>
            </div>
