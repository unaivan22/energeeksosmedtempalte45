              ...
              <div className='w-[1000px] min-h-[200px] h-fit pt-40 pb-8 px-10 bg-[#E74C3C] opacity-90 rounded-t-[30px]'>
                <div className='flex flex-col text-left gap-2 htmlrender-detail'>
                  ...
                  <div className='flex items-center justify-between mt-10'>
                    <p className='text-white w-full text-[1.4rem] font-light text-left'> {isCheckedCopyright ? ( <div className='flex items-center gap-2 justify-start'><Camera className='w-8 h-8' /> <HtmlRenderer html={inputEventDescCopyright} /></div> ) : null}</p>
                    <p className='text-white w-full font-semibold text-[1.6rem] py-6'>{isCheckedHastag ? ( <div className='flex flex-row items-center justify-end gap-x-2'><HtmlRenderer html={inputEventDescHastag} /><ArrowRight className='w-7 h-7' /> </div> ) : null}</p>
                  </div>
                </div>
              </div>
            </div>
