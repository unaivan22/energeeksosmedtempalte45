        ...
        <div className={`safe-area flex items-start justify-start w-full scale-[.7] -translate-y-[8vh] -translate-x-[10vw]`}>
          <div className={`w-[1000px] h-[1000px] overflow-hidden relative shadow-2xl flex flex-col items-center justify-center bg-white renderthis` } ref={elementRef}>
            ...
            <div className='absolute bottom-0 left-0'>
              <div className='w-[1000px] min-h-[200px] h-fit pt-12 pb-8 px-10 bg-[#E74C3C] opacity-90 rounded-t-[30px]'>
                <div className='flex flex-col text-left gap-2 htmlrender-detail'>
                  <h1 className='text-white text-[2.5rem] w-full font-bold leading-none' id='title'>{isCheckedTitle ? ( <div><HtmlRenderer html={inputEventDescTitle} /></div> ) : null} </h1>
                  <p className='text-white w-full text-[1.6rem]'>{isCheckedSubTitle ? ( <div><HtmlRenderer html={inputEventDescSubTitle} /></div> ) : null}</p>
