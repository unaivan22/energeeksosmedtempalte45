        ...
        <div className={`safe-area flex items-start justify-start w-full scale-[.7] -translate-y-[20vh]`}>
          <div className={`w-[1200px] h-[1500px] overflow-hidden relative shadow-2xl flex flex-col items-center justify-center bg-white renderthis` } ref={elementRef}>
            ...
            <div className='absolute bottom-0 left-0'>
              <div className='w-[1200px] min-h-[200px] h-fit pt-12 pb-8 px-10 bg-[#E74C3C] opacity-90 rounded-t-[30px]'>
                <div className='flex flex-col text-left gap-2 htmlrender-detail px-[40px] pt-[30px]'>
                  <h1 className='text-white text-[2.8rem] w-full font-bold leading-none' id='title'>{isCheckedTitle ? ( <div><HtmlRenderer html={inputEventDescTitle} /></div> ) : null} </h1>
                  <p className='text-white w-full text-[1.9rem]'>{isCheckedSubTitle ? ( <div><HtmlRenderer html={inputEventDescSubTitle} /></div> ) : null}</p>
            ...
            <div className='flex flex-col gap-y-3'>
              ...
              <Tabs defaultValue="title" className="w-full">
                <TabsList className="grid w-full grid-cols-4 mb-6">
                  ...
                  <TabsTrigger value="hastag">Tag</TabsTrigger>
