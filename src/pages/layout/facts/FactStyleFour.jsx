        ...
        <div className={`safe-area flex items-start justify-start w-full scale-[.7] -translate-y-[20vh] -translate-x-[10vw]`}>
          ...
          {isCheckedOverlay && (
            <div className='absolute bottom-16 w-[1000px]'>
                <p className='text-white w-full text-[2rem] font-light text-center'> {isCheckedCopyright ? ( <div className='flex items-center gap-2 justify-center'><Camera className='w-8 h-8' /> <HtmlRenderer html={inputEventDescCopyright} /></div> ) : null}</p>
            </div>
            )}
