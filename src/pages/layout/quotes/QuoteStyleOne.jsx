      ...
      <div className='relative gap-6 mt-12'>
        ...
        <div className={`safe-area flex items-start justify-start w-full scale-[.7] -translate-y-[8vh] -translate-x-[10vw]`}>
          <div className={`w-[1000px] h-[1000px] overflow-hidden relative shadow-2xl flex flex-col items-center justify-center renderthis bg-[#E74C3C]` } ref={elementRef}>
            ...
            {previewURL && (
              <div className='z-50 absolute w-[840px] grid h-[1000px] place-items-center'>
                {isCheckedDesc && (
                  <div className='mb-12'>
                    <div className='flex flex-col text-left htmlrender-detail min-w-[840px]'>
          ...
          <div className='z-50 absolute bottom-12 right-[80px]'>
            <div className='mb-12'>
              <div className='flex flex-col text-left'>
              <p className='text-white w-full text-[1.4rem] font-light text-right'>{isCheckedCopyright ? ( <div className='flex items-center gap-2 justify-end'><Camera className='w-8 h-8' /><HtmlRenderer html={inputEventDescCopyright} /></div> ) : null}</p>
              </div>
            </div>
          </div>
