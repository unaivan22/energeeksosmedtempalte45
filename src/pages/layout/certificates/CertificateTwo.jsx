...
function CertificateTwo() {
  ...
  const [inputEventDescPerson, setInputEventDescPerson] = useState('Rp. 00');
      ...
      <div className='relative gap-6 mt-12'>
        ...
        <div className={`safe-area flex items-start justify-start w-full scale-[.7] -translate-x-[5vw]`}>
          <div className={`w-[842px] h-[595px] overflow-hidden relative shadow-2xl flex flex-col items-center justify-center renderthis certificate-one bg-[#F5F0E2]` } ref={elementRef}>
            ...
            {previewURL && (
            <div className='absolute left-1/2 transform -translate-x-1/2 top-20 z-50'>
                <LogoRedSm />
            </div>
            )}
                ...
                {isCheckedDesc && (
                  <div className='mt-20'>
                    <div className='flex flex-col'>
                      ...
                      <h1 className='text-[#1F305C] text-[32px] leading-[3.5rem] w-full text-center josefin-slab font-light leading-tight pt-6' >{isCheckedDesc ? ( <div><HtmlRenderer html={inputEventDescDesc} /></div> ) : null} </h1>
                    </div>
                    <h1 className='text-black text-[20px] py-4 w-full text-center josefin-slab font-light leading-tight' >Nominal Hadiah : </h1>
                    <div className='flex flex-col text-left'>
                      <h1 className='text-[#FF4D39] text-[68px] w-full text-center font-bold leading-none almendra'>{isCheckedPersonName ? ( <div><HtmlRenderer html={inputEventDescPerson} /></div> ) : null} </h1>
