          ...
          <div className={`w-[1000px] h-[1000px] overflow-hidden relative shadow-2xl flex flex-col items-center justify-center renderthis bg-white` } ref={elementRef}>
            {previewURL && (
              <div className='cursor-grab top-0' id='StepName'>
                ...
                <motion.img src={previewURL} alt="Preview" className={`absolute -top-[500px] left-0 scale-${sliderValueScale}`}  drag dragConstraints={constraintsRef}/>
              </div>
            )}
            ...
            {isCheckedOverlay && (
              <div className='z-50 pb-6 absolute bottom-32 w-[756.1px]'>
                <div className='flex flex-row text-left gap-12 htmlrender-detail'>
                  <h1 className='text-black text-[2.5rem] w-full font-bold leading-none' id='title'>{isCheckedTitle ? ( <div><HtmlRenderer html={inputEventDescTitle} /></div> ) : null} </h1>
                  <p className='text-black w-full text-[1.3rem]'>{isCheckedSubTitle ? ( <div><HtmlRenderer html={inputEventDescSubTitle} /></div> ) : null}</p>
                </div>
              </div>
            )}
            ...
            <svg width="1154" height="1154" className='scale-[.4] absolute -bottom-[500px] -left-[550px] opacity-20' viewBox="0 0 577 577" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#clip0_38_123)">
              <path d="M288.38 576.413C447.469 576.413 576.436 447.446 576.436 288.357C576.436 129.268 447.469 0.300781 288.38 0.300781C129.291 0.300781 0.324219 129.268 0.324219 288.357C0.324219 447.446 129.291 576.413 288.38 576.413Z" fill="url(#paint0_radial_38_123)"/>
              </g>
              <defs>
            ...
            <svg width="1154" height="1154" className='scale-[.5] absolute -bottom-[600px] -right-[550px] opacity-20' viewBox="0 0 577 577" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#clip0_38_123)">
              <path d="M288.38 576.413C447.469 576.413 576.436 447.446 576.436 288.357C576.436 129.268 447.469 0.300781 288.38 0.300781C129.291 0.300781 0.324219 129.268 0.324219 288.357C0.324219 447.446 129.291 576.413 288.38 576.413Z" fill="url(#paint0_radial_38_123)"/>
              </g>
              <defs>
            ...
            {/* {isCheckedOverlay && (
              <div className='absolute bottom-0 left-0 h-[140px] w-full opacity-50'>
...
export default PostStyleSeventeen;
