                  ...
                  <div
                    ...
                    >
                      <div className="cursor-move select-none">
                        <h1 className={`text-white text-[5.3rem] w-full font-bold font-size-${sliderEventDescTitle}`} id='title'>{isCheckedTitle ? ( <div><HtmlRenderer html={inputEventDescTitle} /></div> ) : null} </h1>
                      </div>
