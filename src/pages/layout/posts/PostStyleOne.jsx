      ...
      <div className='relative gap-6 mt-12'>
        ...
        <div className={`safe-area flex items-start justify-start w-full scale-[.7] -translate-y-[20vh] -translate-x-[10vw]`}>
          <div className={`w-[1200px] h-[1500px] overflow-hidden relative shadow-2xl flex flex-col items-center justify-center bg-white renderthis` } ref={elementRef}>
            ...
            {/* {`w-full shadow-2xl flex flex-col items-center justify-center bg-white renderthis ${!previewURL && 'hidden'} p-${sliderValuePadding} pb-3` } */}
            ...
            {previewURL && (
              <div className='absolute top-0 left-0 h-[250px] w-full'>
                <div className='bg-gradient-to-b from-[#000000CC] to-[#00000000] h-[250px]'></div>
              </div>
            )}

            {previewURL && (
              <div className='z-50 pb-16 absolute bottom-0 w-[1040px]'>
                <div className='flex flex-col text-left gap-4 htmlrender-detail'>
                  <h1 className='text-white text-[3.8rem] w-full font-bold leading-none' id='title'>{isCheckedTitle ? ( <div><HtmlRenderer html={inputEventDescTitle} /></div> ) : null} </h1>
                  <p className='text-white w-full text-[2.2rem]'>{isCheckedSubTitle ? ( <div><HtmlRenderer html={inputEventDescSubTitle} /></div> ) : null}</p>
                  <p className='text-white w-full text-[2rem] font-light text-center mt-8'> {isCheckedCopyright ? ( <div className='flex items-center gap-2 justify-start'><Camera className='w-8 h-8' /> <HtmlRenderer html={inputEventDescCopyright} /></div> ) : null}</p>
                </div>
              </div>
            )}

            <svg width="577" height="577" className='scale-[.4] absolute -bottom-[170px] -left-[250px]' viewBox="0 0 577 577" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg width="577" height="577" className='scale-[.4] absolute -bottom-[220px] -right-[250px]' viewBox="0 0 577 577" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#clip0_38_123)">
              <path d="M288.38 576.413C447.469 576.413 576.436 447.446 576.436 288.357C576.436 129.268 447.469 0.300781 288.38 0.300781C129.291 0.300781 0.324219 129.268 0.324219 288.357C0.324219 447.446 129.291 576.413 288.38 576.413Z" fill="url(#paint0_radial_38_123)"/>
              </g>
              <defs>
            ...
            <div className='absolute bottom-0 left-0 h-[580px] w-full'>
