          ...
          <div className={`w-[1000px] h-[1000px] overflow-hidden relative shadow-2xl flex flex-col items-center justify-center bg-white renderthis` } ref={elementRef}>
            ...
            {previewURL && (
              <div className='absolute top-0 left-0 h-[200px] w-full'>
                <div className='bg-gradient-to-b from-[#000000CC] to-[#00000000] h-[170px]'></div>
              </div>
            )}

            {previewURL && (
              <div className='z-50 pb-16 absolute bottom-0 w-[896.1px]'>
                <div className='flex flex-col text-left gap-4 htmlrender-detail'>
                  <h1 className='text-white text-[3rem] w-full font-bold leading-none' id='title'>{isCheckedTitle ? ( <div><HtmlRenderer html={inputEventDescTitle} /></div> ) : null} </h1>
                  <p className='text-white w-full text-[1.5rem]'>{isCheckedSubTitle ? ( <div><HtmlRenderer html={inputEventDescSubTitle} /></div> ) : null}</p>
                  <p className='text-white w-full text-[1.4rem] font-light text-center mt-8'> {isCheckedCopyright ? ( <div className='flex items-center gap-2 justify-start'><Camera className='w-8 h-8' /> <HtmlRenderer html={inputEventDescCopyright} /></div> ) : null}</p>
                </div>
              </div>
            )}
            ...
            <div className='absolute bottom-0 left-0 h-[380px] w-full'>
