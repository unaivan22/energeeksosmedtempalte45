      ...
      <div className='relative gap-6 mt-12'>
        ...
        <div className={`safe-area flex items-start justify-start w-full scale-[.7] -translate-y-[20vh] -translate-x-[10vw]`}>
          <div className={`w-[1200px] h-[1500px] overflow-hidden relative shadow-2xl flex flex-col items-center justify-center bg-white renderthis` } ref={elementRef}>
            ...
            {isCheckedOverlay && (
              <div className='z-50 pb-6 absolute top-[260px] w-[940px]'>
                <div className='flex flex-col text-left gap-5 htmlrender-detail'>
                  <h1 className='text-white text-[3.2rem] w-full font-bold leading-none' id='title'>{isCheckedTitle ? ( <div><HtmlRenderer html={inputEventDescTitle} /></div> ) : null} </h1>
            ...
            {isCheckedOverlay && (
              <div className='absolute top-0 left-0 h-[850px] w-full'>
                <div className='bg-gradient-to-b from-[#000000] via-[#000000E6] to-[#E74C3C00] h-full'></div>
              </div>
            )}
