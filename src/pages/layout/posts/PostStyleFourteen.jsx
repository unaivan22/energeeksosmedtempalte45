      ...
      <div className='relative gap-6 mt-12'>
        ...
        <div className={`safe-area flex items-start justify-start w-full scale-[.7] -translate-y-[8vh] -translate-x-[10vw]`}>
          <div className={`w-[1000px] h-[1000px] overflow-hidden relative shadow-2xl flex flex-col items-center justify-center bg-white renderthis` } ref={elementRef}>
            ...
            {isCheckedOverlay && (
              <div className='z-50 pb-6 absolute top-44 w-[600.1px]'>
                <div className='flex flex-col text-center gap-6 htmlrender-detail'>
                  <h1 className='text-black text-[3em] w-full font-bold leading-none' id='title'>{isCheckedTitle ? ( <div><HtmlRenderer html={inputEventDescTitle} /></div> ) : null} </h1>
            ...
            {isCheckedOverlay && (
              <div className='absolute top-0 left-0 h-[900px] w-full'>
