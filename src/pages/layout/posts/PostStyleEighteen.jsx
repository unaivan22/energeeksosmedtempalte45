                  ...
                  <div
                    ...
                    >
                      <div className="cursor-move select-none">
                        <h1 className={`text-[#E74C3C] w-full font-bold font-size-${sliderEventDescTitle}`} id='title'>{isCheckedTitle ? ( <div><HtmlRenderer html={inputEventDescTitle} /></div> ) : null} </h1>
                      </div>
