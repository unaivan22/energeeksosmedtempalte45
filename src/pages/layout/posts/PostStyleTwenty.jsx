...
function PostStyleTwenty() {
  ...
  const [widthTitle, setWidthTitle] = useState(900);
  ...
  const [widthSubTitle, setWidthSubTitle] = useState(900);
      ...
      <div className='relative gap-6 mt-12'>
        ...
        <div className={`safe-area flex items-center justify-center w-full scale-[.7] -translate-y-[20vh]`}>
          <div className={`w-[1200px] h-[1500px] overflow-hidden relative shadow-2xl flex flex-col items-center justify-center bg-white renderthis` } ref={elementRef}>
            ...
            {isCheckedOverlay && (
              <div className='z-50 pb-6 w-[1000.1px] top-[0px] left-0 absolute'>
                <div className='flex flex-col items-start justify-start text-left gap-5 htmlrender-detail bg-[#E74C3C] w-full p-12'>
                  <div className='pb-8'>
                    <LogoWhite />
                  </div>
                  <div
...
export default PostStyleTwenty;
