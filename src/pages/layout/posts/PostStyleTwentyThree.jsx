          ...
          <div className={`w-[1200px] h-[1500px] overflow-hidden relative shadow-2xl flex flex-col items-center justify-center renderthis bg-[#E74C3C]` } ref={elementRef}>
            {previewURL && (
              <div className='cursor-grab bottom-0' id='StepName'>
                ...
                <motion.img src={previewURL} alt="Preview" className={`absolute bottom-0 max-w-[80%] left-0 scale-${sliderValueScale}`}  drag dragConstraints={constraintsRef}/>
              </div>
            )}
            ...
            {isCheckedOverlay && (
              <div className='z-50 pb-6 absolute top-[300px] w-[1040px]'>
                <div className='flex flex-col text-right gap-5 htmlrender-detail'>
                  <div
            ...
            {isCheckedOverlay && (
              <div className='absolute top-[680px] right-[110px] z-50'>
                <div className='h-[60px] bg-yellow-300 w-[900px]'>
                </div>
              </div>
            )}
...
export default PostStyleTwentyThree;
