        ...
        <div className='gap-6 mt-16 grid md:grid-cols-4 grid-cols-1'>
          <div className={`col-span-4 md:col-span-3 safe-area flex items-start justify-start w-full scale-[1] md:scale-[.85] mb-24 md:mb-2`}>
            <div className={`w-[400px] md:w-[800px] aspect-square overflow-hidden relative shadow-2xl flex flex-col items-center justify-center bg-white renderthis` } ref={elementRef}>
              ...
              {isCheckedTitle ? ( 
              <div className='absolute bottom-[38px] md:bottom-[80px] z-[999]'>
                <div className='flex flex-col items-center gap-2 md:gap-4 md:mb-2 '>
                  ...
                  <div className='berkshireswash text-[26px] md:text-[60px] leading-[26px] md:leading-[60px] font-bold text-white'>
                    <HtmlRenderer html={inputEventDescSubTitle} />
                  </div>
                </div>
                <div className='berkshireswash text-[14.7px] md:text-[23.7px] leading-[22px] md:leading-[22px]  font-bold text-white text-center'>
...
export default TwibbonLebaran2025;
